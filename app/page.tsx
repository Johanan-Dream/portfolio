...
export default function Home() {
  return <main id="top">
    ...
    <section className="intro-strip" aria-label="경력 요약"><div><small>ROLE</small><strong>백엔드 중심</strong></div><div><small>BUILD</small><strong>0 → 1 서비스</strong></div><div><small>RANGE</small><strong>기획부터 배포까지</strong></div><div><small>AI-NATIVE</small><strong>빠르게 만들고 검증</strong></div></section>
