...
export const projects: Project[] = [
  ...
  { number:"04", slug:"finance-healthcare", period:"2024.08 — 2025.01", title:"금융회사 헬스케어 서비스", role:"백엔드 개발 · 8인 프로젝트", summary:"체중·혈압·혈당 데이터를 관리하고 사용자별 목표와 건강 루틴을 제공하는 서비스 개발에 참여했습니다.", scope:"건강 데이터 · 목표·루틴 · 배치 처리 · 이벤트", stack:["Java","Spring","Oracle","JavaScript"], category:"company", team:8, link:"https://play.google.com/store/apps/details?id=com.mMiraeAssetLife", image:"/projects/finance-healthcare.png", about:"금융에 건강을 더해 새로워진 M-LIFE. 알고리즘으로 분석된 AI 건강 솔루션과 나만의 건강 루틴 생성으로 활동 리포트를 제공하고, 365일 건강 체크를 돕는 건강 캘린더를 갖췄습니다. (출처: Google Play 앱 소개)", details:[{title:"건강 데이터 기능",description:"체중·혈압·혈당 등록과 조회·수치 구간별 안내·건강정보 기반 목표와 루틴 추천 기능을 구현했습니다.",image:"/projects/finance-healthcare-2.png"},{title:"배치 예외 처리",description:"일부 사용자의 잘못된 데이터 때문에 전체 작업이 중단되지 않도록 사용자 단위로 예외를 분리했습니다."},{title:"환경별 SQL 대응",description:"개발 환경과 내부망의 SQL 실행 결과 차이를 확인하고 날짜 조건을 조정해 동일한 결과가 나오도록 수정했습니다."}]},
  { number:"05", slug:"airport-fx-board", period:"2023.12 — 2024.01", title:"공항 환율전광판 구축", role:"백엔드 개발 · 2인 프로젝트", summary:"은행에서 받은 환율 데이터를 공항 전광판 규칙에 맞게 변환하고 본사 시연부터 현장 설치까지 참여했습니다.", scope:"환율 데이터 변환 · 주기적 갱신 · 현장 설치", stack:["Java","JavaScript","jQuery","MCI"], category:"company", team:2, details:[{title:"환율 데이터 변환",description:"은행과 고객 관점의 환율 방향과 입국장·출국장별 적용 기준을 확인해 국가별 표시 데이터로 변환했습니다."},{title:"주기적 데이터 갱신",description:"선택한 서버에서 환율 정보를 일정 주기로 조회하고 서버가 바뀌면 갱신 작업도 다시 설정되도록 구현했습니다."},{title:"현장 적용",description:"본사 시연에서 받은 피드백을 반영하고 공항 전광판에 직접 설치해 실제 데이터 출력을 확인했습니다."}]},
];
